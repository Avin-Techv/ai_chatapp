...
# from django.contrib import (PermissionsMixin, AbstractBaseUser, UserManager) 
...
#add new properties access_token, is email verified
# Use email and password instead of user_name/password
